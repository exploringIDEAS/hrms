...
public class AddEmpLeaveStockReq {
    @Positive
    private int empId;
    @Min(0)
    ...
    public AddEmpLeaveStockReq() {
    }

    public AddEmpLeaveStockReq(int empId, int sickLeave, int casualLeave, int earnedLeave, int maternityLeave, int paternityLeave, Date calendarStartDate, Date calendarEndDate) {
        this.empId = empId;
